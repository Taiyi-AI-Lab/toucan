...
def get_args():
    ...
    parser.add_argument("--parallel_function_calls", type=str2bool, default=False, help="Parallel function calls (default: False)")
    ...
    def process_single_item_with_fallback(self, item_data):
        ...
        if agent_failed:
            ...
            if args.enable_tool_hint:
                ...
                tool_list = normalize_target_tools(item.get('target_tools', []))
