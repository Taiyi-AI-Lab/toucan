...
This is a faithfulness check. Tool outputs are treated as ground truth. It uses
the same OpenAI-compatible judge configuration variables as `traj_qc_llm.py`.
