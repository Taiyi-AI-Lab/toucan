...
This uses DeepSeek to score `completeness` from 1 to 5. Conciseness is not used
as a hard filter because it caused false negatives for useful long tool-use
trajectories.
