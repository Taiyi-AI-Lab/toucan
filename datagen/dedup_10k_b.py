...
import faiss
rows=[json.loads(l) for l in open("/data/scripts/Toucan/datagen/questions_10k_b.jsonl")]
...
with open("/data/scripts/Toucan/datagen/questions_10k_b_dedup.jsonl","w") as f:
    for r in kept: f.write(json.dumps(r,ensure_ascii=False)+"\n")
print("DEDUPB_DONE -> questions_10k_b_dedup.jsonl")
