...
def get_args():
    ...
    parser.add_argument("--parallel_function_calls", type=str2bool, default=False, help="Parallel function calls")
...
def build_agent_input_messages(messages):
    """Qwen Agent does not reliably replay prior tool-call history. For later
    turns, pass a compact text history plus the new user request, then merge the
    generated assistant/tool tail back onto the original messages.
    """
