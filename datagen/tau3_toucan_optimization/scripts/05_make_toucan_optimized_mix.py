...
def main():
    out_dir = DATA_DIR / "toucan_optimized_mix_v1"
    ...
    hard = list(read_jsonl(DATA_DIR / "toucan_hard_subset_sft.jsonl"))
    ...
    manifest = {
        ...
        "hard_subset": len(hard),
        "generated": len(generated),
        "dropped_generated": dropped_generated,
        "train_formula": "base_train + 2x hard_subset + 3x generated",
        "eval_formula": "base_eval + 5% hard_subset cap200 + 5% generated cap200",
